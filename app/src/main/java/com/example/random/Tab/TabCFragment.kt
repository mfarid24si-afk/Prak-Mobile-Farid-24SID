package com.example.random.Tab
...
import com.example.random.Home.pertemuan_10.ProductAdapter
import com.example.random.Home.pertemuan_10.ProductModel
// Pastikan nama package binding fragment_tab_c di bawah ini sudah sesuai dengan proyek Anda
import com.example.random.databinding.FragmentTabCBinding
...
class TabCFragment : Fragment() {
    ...
    // Menampung daftar data produk yang akan ditampilkan
    ...
    override fun onCreateView(
        ...
        // Memasang View Binding ke layout fragment_tab_c
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Membuat objek adapter dan mengirim daftar produk beserta aksi kliknya
        ...
        // Mengonfigurasi RecyclerView dengan susunan Grid (2 Kolom)
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        _binding = null // Mencegah kebocoran memori saat Fragment dihancurkan
    }

    companion object {
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            TabCFragment().apply { // Pastikan di sini memanggil kelasnya sendiri (TabCFragment)
